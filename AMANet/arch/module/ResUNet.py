...
class UResEncoder(nn.Module):
    def __init__(self,block, input_channels=3 , layers=[2, 2, 2, 2], layer_num= 4, neck_planes  = 64, att_tag = False,memory_module=True, bn_tag=False, last_layer_softmax = False):        
